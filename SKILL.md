...
4. Translate paragraph by paragraph under the content standard. Write one concise Chinese reading note only for each section or subsection heading.
...
- One Chinese reading note after each section/subsection heading; no paragraph-by-paragraph AI commentary.
- Notes on every paragraph pair and figure, stored locally in the browser, with tags and a “待讨论” flag.
...
- A restrained paper-like layout: English body 17 px, Chinese body 16 px, compact 12.5 px legends, clear major-section pauses, tighter Results-subsection spacing, and figures visually attached to the paragraphs that introduce them.
